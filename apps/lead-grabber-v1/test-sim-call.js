import { PrismaClient } from '/Users/user/code/projects/a2p/apps/lead-grabber-v1/clearsky-db-client/index.js';
import dotenv from 'dotenv';
import * as jose from 'jose';

dotenv.config({ path: '/Users/user/code/projects/a2p/apps/lead-grabber-v1/.env' });
...
async function main() {
  const user = await prisma.user.findFirst({
    where: { email: 'userydayo@gmail.com' }
  });
  if (!user) {
